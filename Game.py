...
class Game:
    ...
    def __init__(self, game_surface, size):
        ...
        self.ship = Ship(self.surface, (250, 250), pygame.Color('white'))
...
class Ship:
        def __init__(self, surface, center, color):
            self.surface = surface
            self.color = color #pygame.Color
            self.velocity = [0, 0]
            self.acceleration = [0, 0]
            self.length = [10, 7, 7]
            self.angle = [90, 225, 315]
            self.important_surface = pygame.Surface((100,100))
            self.center = center
        ...
        def draw(self):
            pygame.draw.polygon(self.surface, self.color, self.polygon)
        ...
        def shoot(self):
            return Bullet(self.surface, self.angle[0], self.polygon1, self.color, 5)
...
class Asteroid(pygame.sprite.Sprite):
    ...
    def update_mask(self):
        self.ASTEROID = pygame.Rect((30,30), pygame.SRCALPHA)
        self.mask = pygame.mask.from_surface(self.ASTEROID)
main()